Pod::Spec.new do |s|  
    s.name              = "mobile-ffmpeg-tvos-full-gpl"
    s.version           = "VERSION"
    s.summary           = "Mobile FFmpeg tvOS Full GPL Static Framework"
    s.description       = <<-DESC
