Pod::Spec.new do |s|  
    s.name              = "mobile-ffmpeg-tvos-full"
    s.version           = "VERSION"
    s.summary           = "Mobile FFmpeg tvOS Full Static Framework"
    s.description       = <<-DESC
    ...
    s.source            = { :http => "https://github.com/getearlybirdapp/mobile-ffmpeg/releases/download/vVERSION/mobile-ffmpeg-full-VERSION-tvos-framework.zip" }
